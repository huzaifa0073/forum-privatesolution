...
export const THREADS: Thread[] = [
  ...
  {
    id: '3',
    title: '[VENDOR] SpectralDMA — EAC/BE Firmware + Setup Support',
  ...
  {
    id: '7',
    title: '[WTS] 75T Firmware — HWID Spoofer included',
    categorySlug: 'marketplace',
    categoryName: 'Marketplace',
    author: MEMBERS[6],
    replyCount: 12,
    ...
    content: `Selling custom 75T firmware with built-in HWID spoofer. Supports EAC, BE. DM for price.`,
    replies: [],
  },
  {
    id: '8',
...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    slug: 'marketplace',
    name: 'Marketplace',
    description: 'Buy, sell, and review firmware, hardware, and private solutions.',
    icon: '🛒',
    color: 'text-purple-400',
    threadCount: 89,
    postCount: 1243,
    subforums: [
      { slug: 'marketplace/vendors', name: 'Verified Vendors', description: 'Trusted seller threads', threadCount: 22 },
      { slug: 'marketplace/wts', name: 'WTS / WTB', description: 'Community buy and sell', threadCount: 67 },
    ],
    latestThread: {
      title: '[VENDOR] SpectralDMA — EAC/BE Firmware + Setup Support',
      id: '3',
